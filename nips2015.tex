...
Though not fully matching the performances of deep networks trained on massive quantities of data, such models nonetheless are surprisingly effective in regimes where limited training data is available \cite{cox2011beyond, yamins2014performance}. %\eg the LFW-a setting we used \cite{krizhevsky2012imagenet} \cite{pinto2009high, cox2011beyond, viglarge}.
